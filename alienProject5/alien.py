...
class AlienFleet:
    ...
    #alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/alien0{n}.bmp'), 0, 1.2) for n in range(3)]
...
class Alien(Sprite):
    def __init__(self, game, image_list, alien_index, sound, start_index=0, ul=(0, 100), v=Vector(1, 0),
        ...
        self.image_10 = pg.image.load('images/test1.png')
        self.image_20 = pg.image.load('images/20.png')
        self.image_40 = pg.image.load('images/40.png')
    ...
    def draw(self):
      ...
      if(self.dying):
          if(self.points == 10):
              self.screen.blit(self.image_10, self.rect)
          elif (self.points == 20):
              self.screen.blit(self.image_20, self.rect)
          elif (self.points == 40):
              self.screen.blit(self.image_40, self.rect)
